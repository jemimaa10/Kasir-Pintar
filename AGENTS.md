...
- Workspace ID: `825c89b5-0f52-405e-8453-a3a5d107423f`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/825c89b5-0f52-405e-8453-a3a5d107423f.
...
2. `npx ngodingpakeai connect --workspace 825c89b5-0f52-405e-8453-a3a5d107423f --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/825c89b5-0f52-405e-8453-a3a5d107423f. Only pass on links the CLI actually printed — never assemble one from an id yourself.
